...
for (const user of usersList) {
    ...
    divLng.innerText =`Lng: ${user.address.geo.lng}`;
    ...
    divCompany.style.marginBottom='5px'

    let divCompName = document.createElement('div');
    divCompName.innerText = `Name: ${user.company.name}`;
    divCompany.appendChild(divCompName);

    let divCompBs = document.createElement('div');
    divCompBs.innerText = `Bs: ${user.company.bs}`;
    divCompany.appendChild(divCompBs);

    let divCompPhrase = document.createElement('div');
    divCompPhrase.innerText = `CatchPhrase: ${user.company.catchPhrase}`;
    divCompany.appendChild(divCompPhrase);


    divUser.appendChild(divId);
    divUser.appendChild(divName);
    divUser.appendChild(divUserName);
    divUser.appendChild(divEmail);
    divUser.appendChild(divAddress);
    divUser.appendChild(divPhone);
    divUser.appendChild(divWebsite);
    divUser.appendChild(divCompany);
