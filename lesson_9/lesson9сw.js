...
for (const simpson of simpsons){
    ...
    divSimpson.innerText=`${simpson.name}, ${simpson.surname}, ${simpson.age}`;
...
for (const coursesArrayElement of coursesArray) {
    ...
    for (const divModule of coursesArrayElement.modules) {
        let module=document.createElement('li')
        module.innerText=divModule;
        divModules.appendChild(module);
    }

    divCourse.appendChild(divTitle);
    divCourse.appendChild(divMonthDuration);
    divCourse.appendChild(divHourDuration);
